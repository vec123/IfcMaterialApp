...
from app.loader.loader import clear_cuda_runtime, get_app_config, get_ifc_RAG_search_services

# Clean fragmented VRAM early before initialization sequences
#clear_cuda_runtime()

# Load the dynamic configuration object (Single Source of Truth)
cfg = st.session_state.cfg #build_cfg()
...
if user_query:
    ...
    search_service, extraction_agent, material_collection, model_name = get_ifc_RAG_search_services(cfg)
